; Forth-Core.asm
; Friday, September 15, 2023 5:00:47 PM
; FJRusso Vs 1.2
; Frank's attempt at a FORTH Core in 64 bit Assm
;
; nasm -f coff Forth-Core.asm -l errorfile.lst
; Using MASM32
;
.486
.MODEL flat,stdcall
...
.data ; Data Section
;
R0 DD 256 dup (0H) ; Return Stack Base of size 1024 
...
; LEA EAX , R0
; ADD EAX ,1023 ; Saving Return Stack Pointer Base
; PUSH EAX
; POP RSP
LEA EAX, h_COMPILE
PUSH EAX
...
; Inner Interpreter
;
; Load DI with Forth_Thread
LEA EDI ,  Forth_Thread
; Following lines may not be necesssary 
; MOV [RP-4] , WORD Forth_Thread + 4 ; Push the second word on to RP stack
; MOV [RP] , WORD RP-4 
;
;  
   NEXTC
